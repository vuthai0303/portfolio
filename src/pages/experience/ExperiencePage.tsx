  ...
  const timeline = [
    {
      ...
      tasks: {
        sdm: [
          {
            title: t('Experience.systemEXE.sdm.title'),
            description: t('Experience.systemEXE.sdm.description'),
            time: '2026/05 - 2026/06',
            frontend: ['HTML', 'CSS', 'Typescript', 'vue2'],
            backend: ['Java', 'Spring boot', 'docker', 'PostgreSQL', 'Modular Monolith'],
            position: "Developer",
          },
        ],
        CarShare: [
          {
            ...
            backend: ['Java', 'Spring boot', 'docker', 'MySQL', 'Junit', 'Mockito', 'Microservice'],
            position: "Leader",
          },
        ],
        Heatmap: [
        ...
        Komatsu: [
          {
            ...
            backend: ['Java', 'Spring boot', 'tomcat', 'docker', 'OracleDB', 'Azure', 'Modular Monolith'],
            position: "Developer",
          },
        ],
        Mars: [
          {
            ...
            backend: ['C#', '.NET Framework 4.8', 'OracleDB', 'Nunit', 'bat', 'Monolith'],
            position: "Developer",
          },
        ],
        GCS: [
          {
            ...
            backend: ['Java', 'Spring Boot', 'OracleDB', 'Groovy', 'Mockito', 'Monolith'],
            position: "Developer",
          },
        ],
        Fluzo: [
          {
            ...
            backend: ['Java', 'Spring Boot', 'OracleDB', 'JUnit', 'Mockito', 'Monolith'],
            position: "Developer",
          },
        ],
        CIIC: [
          {
            ...
            backend: ['C#', 'ASP.NET', 'SQL Server', 'Monolith'],
            position: "Developer",
          },
        ],
        RMS: [
          {
            ...
            backend: ['Java', 'Spring Boot', 'PostgreSQL', 'Monolith'],
            position: "Developer",
          },
        ],
      },
